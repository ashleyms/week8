...
if(isset($_GET["page"])) {
    ...
    if($_GET["page"]=== "product"){
      ...
      $result = $CMSControl->add("INSERT INTO product_table (strProductName, strCode, nProductPrice, nProductQty, strProductDescription, strProductIntro, strIngredients, bFeatured, strProductImg ) VALUES ('".$_POST["strProductName"]."', '".$_POST["strCode"]."', '".$_POST["nProductPrice"]."', '".$_POST["nProductQty"]."', '".$_POST["strProductDescription"]."', '".$_POST["strProductIntro"]."', '".$_POST["strIngredients"]."', '".$_POST["bFeatured"]."','".$imagePath."')");
